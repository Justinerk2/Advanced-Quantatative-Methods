...
###b.
####i.
$H_{0}$: Transplants have no effect on patient survial. $p_{t}$ - $p_{c}$ = 0.
$H_{A}$: Transplants have an impact on survival. $p_{t}$ - $p_{c}$ does not equal 0.
####ii.
28, 75, 69, 34, 0, -0.23.
####iii. 
...
$p_{1}$ hat = 0.088
$p_{2}$ hat = 0.08
point estimate: $/hat{p_{1}}$ - $/hat{p_{2}}$ = 0.008
...
##3.30.
###a.
$H_{0}$: Sleep deprevation is not effected by living in different states
$H_{A}$: Sleep deperation is different within Oregan and California
...
###c.
${H_{0}$: $mu_{1}$ - $mu{2}$ =0
$H_{A}$: $mu_{1}$ does not equal $mu_{2}$
SE= 0.894
T = 2.684
df= 504
